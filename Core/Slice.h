...
template <typename T>
Slice<const T> make_slice(std::initializer_list<T> r) { return Slice<const T>(r); }
template <typename T, int N>
Slice<const T> make_slice(const T (&array)[N]) { return Slice<const T>(array); }
template <typename T>
Slice<const T> make_slice(const T *data, int len) { return Slice<const T>(data, len); }
template <typename T, int N>
Slice<T> make_slice(T (&array)[N]) { return Slice<T>(array); }
template <typename T>
Slice<T> make_slice(T *data, int len) { return Slice<T>(data, len); }
